...
#   "generate" "-f" "./Cargo.toml" "-o" "Cargo-generated.nix" "-h" "/nix/store/iqjcwx5dnnjich2y6np5psi8804l6d49-aleph-node-crate2nix/crate-hashes.json"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "aleph-node" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./bin/node; };
        authors = [
          "Cardinal Cryptography"
        ];
        dependencies = [
      ...
      "aleph-runtime" = rec {
        ...
        version = "0.4.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./bin/runtime; };
        authors = [
          "Cardinal Cryptography"
        ];
        dependencies = [
      ...
      "finality-aleph" = rec {
        ...
        version = "0.3.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./finality-aleph; };
        authors = [
          "Cardinal Cryptography"
        ];
        dependencies = [
      ...
      "fork-tree" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          sha256 = "30bd2f1d794c2d5d592ef6361610d891057193ec5b92fd34776dca6e14fb8319";
        };
        authors = [
          "Parity Technologies <admin@parity.io>"
        ];
      ...
      "pallet-aleph" = rec {
        ...
        version = "0.2.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./pallets/aleph; };
        authors = [
          "Cardinal Cryptography"
        ];
        dependencies = [
      ...
      "pallet-elections" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./pallets/elections; };
        dependencies = [
          {
      ...
      "primitives" = rec {
        ...
        version = "0.3.0";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./primitives; };
        authors = [
          "Cardinal Cryptography"
        ];
        dependencies = [
