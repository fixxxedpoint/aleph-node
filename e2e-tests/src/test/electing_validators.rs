...
async fn assert_validators_are_elected_stakers<C: ConnectionApi + StakingRawApi>(
    connection: &C,
...
async fn assert_validators_are_used_as_authorities<C: ConnectionApi + WaitingExt>(
    connection: &C,
