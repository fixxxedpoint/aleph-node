...
async fn get_current_and_next_era_reserved_validators<C: ConnectionApi + ElectionsApi>(
    connection: &C,
...
async fn get_current_and_next_era_non_reserved_validators<C: ConnectionApi + ElectionsApi>(
    connection: &C,
) -> (Vec<AccountId>, Vec<AccountId>) {
